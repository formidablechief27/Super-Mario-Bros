...
class Editor:
	def __init__(self, land_tiles, switch):
		...
		# clouds
		self.current_clouds = []
		self.cloud_surf = import_folder('C:/Users/Dhrumil/MPR/graphics/clouds')
		...
		# music
		# self.editor_music = pygame.mixer.Sound('C:/Users/Dhrumil/MPR/audio/Explorer.ogg')
	...
	def imports(self):
		self.water_bottom = load('C:/Users/Dhrumil/MPR/graphics/terrain/water/water_bottom.png').convert_alpha()
		self.sky_handle_surf = load('C:/Users/Dhrumil/MPR/graphics/cursors/handle.png').convert_alpha()
